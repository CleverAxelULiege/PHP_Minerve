...
export class InterventionFormManager {
    ...
    constructor(rootElement) {
        ...
        this.DOM = {
            ...
            // Side panel elements
            interventionRows: rootElement.querySelectorAll(".intervention_row"),
            interventionDetailsContainer: rootElement.querySelector(".intervention_details_container"),
            interventionDetailsContent: rootElement.querySelector(".intervention_details_container .content"),
